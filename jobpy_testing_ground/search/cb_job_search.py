...
from files.converter import add_to_csv, remove_duplicate_rows, csv_to_md
...
if __name__ == '__main__':
    ...
    start_search("python developer", 'Silicon Valley')

    print("Removing duplicates...")
    remove_duplicate_rows("software_dev_jobs")
